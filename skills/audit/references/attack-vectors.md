...
64 attack vectors. For each: detection pattern (what to look for in code) and false-positive signals (what makes it NOT a vulnerability even if the pattern matches).
...
**11. DoS via Push Payment to Rejecting Contract**
...
**12. Weak On-Chain Randomness / Randomness Frontrunning**
...
**13. Missing or Incorrect Access Modifier**
...
**14. Proxy Storage Slot Collision**
...
**15. Off-By-One in Bounds or Range Checks**
...
**18. Function Selector Clash in Proxy**
...
**19. Missing Nonce (Signature Replay)**
...
**21. L2 Sequencer Uptime Not Checked**
...
**22. Precision Loss - Division Before Multiplication**
...
**23. Return Bomb (Returndata Copy DoS)**
...
**24. Flash Loan-Assisted Price Manipulation**
...
**25. msg.value Reuse in Loop / Multicall**
...
**27. Block Number as Timestamp Approximation**
...
**28. Missing chainId / Message Uniqueness in Bridge**
...
**31. Delegatecall to Untrusted / User-Supplied Callee**
...
**32. Unsafe Downcast / Integer Truncation**
...
**34. Missing or Expired Deadline on Swaps**
...
**35. Missing Storage Gap in Upgradeable Base Contract**
...
**36. Improper Flash Loan Callback Validation**
...
**38. Transient Storage Low-Gas Reentrancy (EIP-1153)**
...
**39. Force-Feeding ETH via selfdestruct or coinbase**
...
**40. CREATE2 Address Reuse After selfdestruct**
...
**41. extcodesize Zero / isContract Bypass in Constructor**
...
**42. Multi-Block TWAP Oracle Manipulation**
...
**43. Missing Input Validation on Critical Setters**
...
**44. Staking Reward Front-Run by New Depositor**
...
**45. ecrecover Returns address(0) on Invalid Signature**
